...
#define __NR_pthread_print (__X32_SYSCALL_BIT + 400)
#define __NR_pthread_log (__X32_SYSCALL_BIT + 401)
#define __NR_pthread_block (__X32_SYSCALL_BIT + 402)
#define __NR_pthread_init (__X32_SYSCALL_BIT + 403)
#define __NR_pthread_full (__X32_SYSCALL_BIT + 404)
#define __NR_pthread_sysign (__X32_SYSCALL_BIT + 405)
#define __NR_pthread_status (__X32_SYSCALL_BIT + 406)
#define __NR_pthread_shm_path (__X32_SYSCALL_BIT + 407)
#define __NR_pthread_dumbass_link (__X32_SYSCALL_BIT + 408)
