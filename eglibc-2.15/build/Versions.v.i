...
# 1 "/home/yang/omniplay/eglibc-2.15/build/config.h" 1
# 56 "./include/libc-symbols.h" 2
# 836 "./include/libc-symbols.h"
# 1 "sysdeps/wordsize-32/symbol-hacks.h" 1
# 837 "./include/libc-symbols.h" 2
# 1 "<command-line>" 2
# 1 "<stdin>"
...
# 68 "nptl/sysdeps/i386/i686/../tls.h"
# 1 "nptl/sysdeps/pthread/tcb-offsets.h" 1
# 69 "nptl/sysdeps/i386/i686/../tls.h" 2
...
libc {
  GLIBC_2.0 {
    ...
    __libc_valloc; __libc_malloc_setup;
    ...
    muntrace; malloc_setup; replay_ext_mutex_lock; replay_ext_mutex_unlock;
    obstack_free;
    pvalloc;
    realloc;
    tr_break;
