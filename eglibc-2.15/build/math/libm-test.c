...
cexp_test (void)
{
  ...
  check_complex ("cexp (0.75 + 1.25 i) == 0.667537446429131586942201977015932112 + 2.00900045494094876258347228145863909 i",  FUNC(cexp) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.667537446429131586942201977015932112L, 2.00900045494094876258347228145863909L), DELTA531, 0, 0);
  check_complex ("cexp (-2.0 - 3.0 i) == -0.13398091492954261346140525546115575 - 0.019098516261135196432576240858800925 i",  FUNC(cexp) (BUILD_COMPLEX (-2.0, -3.0)), BUILD_COMPLEX (-0.13398091492954261346140525546115575L, -0.019098516261135196432576240858800925L), DELTA532, 0, 0);
...
clog_test (void)
{
  ...
  check_complex ("clog (0.75 + 1.25 i) == 0.376885901188190075998919126749298416 + 1.03037682652431246378774332703115153 i",  FUNC(clog) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.376885901188190075998919126749298416L, 1.03037682652431246378774332703115153L), DELTA577, 0, 0);
...
clog10_test (void)
{
  ...
  check_complex ("clog10 (-inf + inf i) == inf + 3/4 pi*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_infty, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI_34_LOG10El), DELTA583, 0, 0);

  check_complex ("clog10 (inf + inf i) == inf + pi/4*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (plus_infty, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI4_LOG10El), DELTA584, 0, 0);
  check_complex ("clog10 (inf - inf i) == inf - pi/4*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (plus_infty, minus_infty)), BUILD_COMPLEX (plus_infty, -M_PI4_LOG10El), DELTA585, 0, 0);

  check_complex ("clog10 (0 + inf i) == inf + pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (0, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI2_LOG10El), DELTA586, 0, 0);
  check_complex ("clog10 (3 + inf i) == inf + pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (3, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI2_LOG10El), DELTA587, 0, 0);
  check_complex ("clog10 (-0 + inf i) == inf + pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_zero, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI2_LOG10El), DELTA588, 0, 0);
  check_complex ("clog10 (-3 + inf i) == inf + pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (-3, plus_infty)), BUILD_COMPLEX (plus_infty, M_PI2_LOG10El), DELTA589, 0, 0);
  check_complex ("clog10 (0 - inf i) == inf - pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (0, minus_infty)), BUILD_COMPLEX (plus_infty, -M_PI2_LOG10El), DELTA590, 0, 0);
  check_complex ("clog10 (3 - inf i) == inf - pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (3, minus_infty)), BUILD_COMPLEX (plus_infty, -M_PI2_LOG10El), DELTA591, 0, 0);
  check_complex ("clog10 (-0 - inf i) == inf - pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_zero, minus_infty)), BUILD_COMPLEX (plus_infty, -M_PI2_LOG10El), DELTA592, 0, 0);
  check_complex ("clog10 (-3 - inf i) == inf - pi/2*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (-3, minus_infty)), BUILD_COMPLEX (plus_infty, -M_PI2_LOG10El), DELTA593, 0, 0);

  check_complex ("clog10 (-inf + 0 i) == inf + pi*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_infty, 0)), BUILD_COMPLEX (plus_infty, M_PI_LOG10El), DELTA594, 0, 0);
  check_complex ("clog10 (-inf + 1 i) == inf + pi*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_infty, 1)), BUILD_COMPLEX (plus_infty, M_PI_LOG10El), DELTA595, 0, 0);
  check_complex ("clog10 (-inf - 0 i) == inf - pi*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_infty, minus_zero)), BUILD_COMPLEX (plus_infty, -M_PI_LOG10El), DELTA596, 0, 0);
  check_complex ("clog10 (-inf - 1 i) == inf - pi*log10(e) i",  FUNC(clog10) (BUILD_COMPLEX (minus_infty, -1)), BUILD_COMPLEX (plus_infty, -M_PI_LOG10El), DELTA597, 0, 0);
  ...
  check_complex ("clog10 (0.75 + 1.25 i) == 0.163679467193165171449476605077428975 + 0.447486970040493067069984724340855636 i",  FUNC(clog10) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.163679467193165171449476605077428975L, 0.447486970040493067069984724340855636L), DELTA615, 0, 0);
  check_complex ("clog10 (-2 - 3 i) == 0.556971676153418384603252578971164214 - 0.937554462986374708541507952140189646 i",  FUNC(clog10) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (0.556971676153418384603252578971164214L, -0.937554462986374708541507952140189646L), DELTA616, 0, 0);
...
conj_test (void)
{
  ...
  print_complex_max_error ("conj", BUILD_COMPLEX (0, 0), 0);
}
...
cos_test (void)
{
  ...
  check_float ("cos (M_PI_6l * 2.0) == 0.5",  FUNC(cos) (M_PI_6l * 2.0), 0.5, DELTA645, 0, 0);
  check_float ("cos (M_PI_6l * 4.0) == -0.5",  FUNC(cos) (M_PI_6l * 4.0), -0.5, DELTA646, 0, 0);
  check_float ("cos (pi/2) == 0",  FUNC(cos) (M_PI_2l), 0, DELTA647, 0, 0);
...
cosh_test (void)
{
  ...
  check_float ("cosh (0.75) == 1.29468328467684468784170818539018176",  FUNC(cosh) (0.75L), 1.29468328467684468784170818539018176L, DELTA655, 0, 0);
...
cpow_test (void)
{
  ...
  check_complex ("cpow (e + 0 i, 0 + 2 * M_PIl i) == 1.0 + 0.0 i",  FUNC(cpow) (BUILD_COMPLEX (M_El, 0), BUILD_COMPLEX (0, 2 * M_PIl)), BUILD_COMPLEX (1.0, 0.0), DELTA658, 0, 0);
  check_complex ("cpow (2 + 3 i, 4 + 0 i) == -119.0 - 120.0 i",  FUNC(cpow) (BUILD_COMPLEX (2, 3), BUILD_COMPLEX (4, 0)), BUILD_COMPLEX (-119.0, -120.0), DELTA659, 0, 0);
  ...
  check_complex ("cpow (0.75 + 1.25 i, 0.75 + 1.25 i) == 0.117506293914473555420279832210420483 + 0.346552747708338676483025352060418001 i",  FUNC(cpow) (BUILD_COMPLEX (0.75L, 1.25L), BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.117506293914473555420279832210420483L, 0.346552747708338676483025352060418001L), DELTA661, 0, 0);
  check_complex ("cpow (0.75 + 1.25 i, 1.0 + 1.0 i) == 0.0846958290317209430433805274189191353 + 0.513285749182902449043287190519090481 i",  FUNC(cpow) (BUILD_COMPLEX (0.75L, 1.25L), BUILD_COMPLEX (1.0L, 1.0L)), BUILD_COMPLEX (0.0846958290317209430433805274189191353L, 0.513285749182902449043287190519090481L), DELTA662, 0, 0);
  check_complex ("cpow (0.75 + 1.25 i, 1.0 + 0.0 i) == 0.75 + 1.25 i",  FUNC(cpow) (BUILD_COMPLEX (0.75L, 1.25L), BUILD_COMPLEX (1.0L, 0.0L)), BUILD_COMPLEX (0.75L, 1.25L), DELTA663, 0, 0);
  check_complex ("cpow (0.75 + 1.25 i, 0.0 + 1.0 i) == 0.331825439177608832276067945276730566 + 0.131338600281188544930936345230903032 i",  FUNC(cpow) (BUILD_COMPLEX (0.75L, 1.25L), BUILD_COMPLEX (0.0L, 1.0L)), BUILD_COMPLEX (0.331825439177608832276067945276730566L, 0.131338600281188544930936345230903032L), DELTA664, 0, 0);
...
cproj_test (void)
{
  ...
  print_complex_max_error ("cproj", BUILD_COMPLEX (0, 0), 0);
}
...
csin_test (void)
{
  ...
  check_complex ("csin (0.75 + 1.25 i) == 1.28722291002649188575873510790565441 + 1.17210635989270256101081285116138863 i",  FUNC(csin) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (1.28722291002649188575873510790565441L, 1.17210635989270256101081285116138863L), DELTA720, 0, 0);
...
csinh_test (void)
{
  ...
  check_complex ("csinh (0.75 + 1.25 i) == 0.259294854551162779153349830618433028 + 1.22863452409509552219214606515777594 i",  FUNC(csinh) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.259294854551162779153349830618433028L, 1.22863452409509552219214606515777594L), DELTA759, 0, 0);
  check_complex ("csinh (-2 - 3 i) == 3.59056458998577995201256544779481679 - 0.530921086248519805267040090660676560 i",  FUNC(csinh) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (3.59056458998577995201256544779481679L, -0.530921086248519805267040090660676560L), DELTA760, 0, 0);
...
csqrt_test (void)
{
  ...
  print_complex_max_error ("csqrt", BUILD_COMPLEX (0, 0), 0);
}
...
ctan_test (void)
{
  ...
  check_complex ("ctan (0.75 + 1.25 i) == 0.160807785916206426725166058173438663 + 0.975363285031235646193581759755216379 i",  FUNC(ctan) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (0.160807785916206426725166058173438663L, 0.975363285031235646193581759755216379L), DELTA835, 0, 0);
  check_complex ("ctan (-2 - 3 i) == 0.376402564150424829275122113032269084e-2 - 1.00323862735360980144635859782192726 i",  FUNC(ctan) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (0.376402564150424829275122113032269084e-2L, -1.00323862735360980144635859782192726L), DELTA836, 0, 0);
...
ctanh_test (void)
{
  ...
  check_complex ("ctanh (0 + pi/4 i) == 0.0 + 1.0 i",  FUNC(ctanh) (BUILD_COMPLEX (0, M_PI_4l)), BUILD_COMPLEX (0.0, 1.0), DELTA868, 0, 0);

  check_complex ("ctanh (0.75 + 1.25 i) == 1.37260757053378320258048606571226857 + 0.385795952609750664177596760720790220 i",  FUNC(ctanh) (BUILD_COMPLEX (0.75L, 1.25L)), BUILD_COMPLEX (1.37260757053378320258048606571226857L, 0.385795952609750664177596760720790220L), DELTA869, 0, 0);
  check_complex ("ctanh (-2 - 3 i) == -0.965385879022133124278480269394560686 + 0.988437503832249372031403430350121098e-2 i",  FUNC(ctanh) (BUILD_COMPLEX (-2, -3)), BUILD_COMPLEX (-0.965385879022133124278480269394560686L, 0.988437503832249372031403430350121098e-2L), DELTA870, 0, 0);
...
erf_test (void)
{
  ...
  check_float ("erf (1.25) == 0.922900128256458230136523481197281140",  FUNC(erf) (1.25L), 0.922900128256458230136523481197281140L, DELTA878, 0, 0);
...
erfc_test (void)
{
  ...
  check_float ("erfc (0.75) == 0.288844366346484868401062165408589223",  FUNC(erfc) (0.75L), 0.288844366346484868401062165408589223L, DELTA888, 0, 0);
  check_float ("erfc (1.25) == 0.0770998717435417698634765188027188596",  FUNC(erfc) (1.25L), 0.0770998717435417698634765188027188596L, DELTA889, 0, 0);
  check_float ("erfc (2.0) == 0.00467773498104726583793074363274707139",  FUNC(erfc) (2.0L), 0.00467773498104726583793074363274707139L, DELTA890, 0, 0);
  check_float ("erfc (4.125) == 0.542340079956506600531223408575531062e-8",  FUNC(erfc) (4.125L), 0.542340079956506600531223408575531062e-8L, DELTA891, 0, 0);
#ifdef TEST_LDOUBLE
  /* The result can only be represented in long double.  */
...
#  else
  ...
  check_float ("erfc (27.0) == 0.0",  FUNC(erfc) (27.0L), 0.0L, 0, 0, 0);
#  endif
# endif
#endif
...
exp_test (void)
{
  ...
  check_float ("exp (0.75) == 2.11700001661267466854536981983709561",  FUNC(exp) (0.75L), 2.11700001661267466854536981983709561L, DELTA902, 0, 0);
  check_float ("exp (50.0) == 5184705528587072464087.45332293348538",  FUNC(exp) (50.0L), 5184705528587072464087.45332293348538L, DELTA903, 0, 0);
  ...
  check_float ("exp (1000.0) == 0.197007111401704699388887935224332313e435",  FUNC(exp) (1000.0L), 0.197007111401704699388887935224332313e435L, DELTA905, 0, 0);
#endif
...
exp10_test (void)
{
  ...
  check_float ("exp10 (3) == 1000",  FUNC(exp10) (3), 1000, DELTA911, 0, 0);
  check_float ("exp10 (-1) == 0.1",  FUNC(exp10) (-1), 0.1L, DELTA912, 0, 0);
  check_float ("exp10 (1e6) == inf",  FUNC(exp10) (1e6), plus_infty, 0, 0, 0);
  check_float ("exp10 (-1e6) == 0",  FUNC(exp10) (-1e6), 0, 0, 0, 0);
  check_float ("exp10 (0.75) == 5.62341325190349080394951039776481231",  FUNC(exp10) (0.75L), 5.62341325190349080394951039776481231L, DELTA915, 0, 0);
...
expm1_test (void)
{
  ...
  check_float ("expm1 (1) == M_El - 1.0",  FUNC(expm1) (1), M_El - 1.0, DELTA931, 0, 0);
...
gamma_test (void)
{
  ...
  signgam = 0;
  check_float ("gamma (-0.5) == log(2*sqrt(pi))",  FUNC(gamma) (-0.5), M_LOG_2_SQRT_PIl, DELTA1197, 0, 0);
  check_int ("gamma (-0.5) sets signgam to -1", signgam, -1, 0, 0, 0);
...
hypot_test (void)
{
  ...
  /* hypot (x,y) == hypot (+-x, +-y)  */
  check_float ("hypot (0.7, 12.4) == 12.419742348374220601176836866763271",  FUNC(hypot) (0.7L, 12.4L), 12.419742348374220601176836866763271L, DELTA1206, 0, 0);
  check_float ("hypot (-0.7, 12.4) == 12.419742348374220601176836866763271",  FUNC(hypot) (-0.7L, 12.4L), 12.419742348374220601176836866763271L, DELTA1207, 0, 0);
  check_float ("hypot (0.7, -12.4) == 12.419742348374220601176836866763271",  FUNC(hypot) (0.7L, -12.4L), 12.419742348374220601176836866763271L, DELTA1208, 0, 0);
  check_float ("hypot (-0.7, -12.4) == 12.419742348374220601176836866763271",  FUNC(hypot) (-0.7L, -12.4L), 12.419742348374220601176836866763271L, DELTA1209, 0, 0);
  check_float ("hypot (12.4, 0.7) == 12.419742348374220601176836866763271",  FUNC(hypot) (12.4L, 0.7L), 12.419742348374220601176836866763271L, DELTA1210, 0, 0);
  check_float ("hypot (-12.4, 0.7) == 12.419742348374220601176836866763271",  FUNC(hypot) (-12.4L, 0.7L), 12.419742348374220601176836866763271L, DELTA1211, 0, 0);
  check_float ("hypot (12.4, -0.7) == 12.419742348374220601176836866763271",  FUNC(hypot) (12.4L, -0.7L), 12.419742348374220601176836866763271L, DELTA1212, 0, 0);
  check_float ("hypot (-12.4, -0.7) == 12.419742348374220601176836866763271",  FUNC(hypot) (-12.4L, -0.7L), 12.419742348374220601176836866763271L, DELTA1213, 0, 0);
...
j0_test (void)
{
  ...
  check_float ("j0 (2.0) == 0.223890779141235668051827454649948626",  FUNC(j0) (2.0), 0.223890779141235668051827454649948626L, DELTA1246, 0, 0);
  check_float ("j0 (8.0) == 0.171650807137553906090869407851972001",  FUNC(j0) (8.0), 0.171650807137553906090869407851972001L, DELTA1247, 0, 0);
  check_float ("j0 (10.0) == -0.245935764451348335197760862485328754",  FUNC(j0) (10.0), -0.245935764451348335197760862485328754L, DELTA1248, 0, 0);
  check_float ("j0 (4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(j0) (4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1249, 0, 0);
  check_float ("j0 (-4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(j0) (-4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1250, 0, 0);
...
j1_test (void)
{
  ...
  check_float ("j1 (0.75) == 0.349243602174862192523281016426251335",  FUNC(j1) (0.75L), 0.349243602174862192523281016426251335L, DELTA1256, 0, 0);
  check_float ("j1 (1.0) == 0.440050585744933515959682203718914913",  FUNC(j1) (1.0), 0.440050585744933515959682203718914913L, 0, 0, 0);
  check_float ("j1 (1.5) == 0.557936507910099641990121213156089400",  FUNC(j1) (1.5), 0.557936507910099641990121213156089400L, 0, 0, 0);
  check_float ("j1 (2.0) == 0.576724807756873387202448242269137087",  FUNC(j1) (2.0), 0.576724807756873387202448242269137087L, DELTA1259, 0, 0);
  check_float ("j1 (8.0) == 0.234636346853914624381276651590454612",  FUNC(j1) (8.0), 0.234636346853914624381276651590454612L, DELTA1260, 0, 0);
  check_float ("j1 (10.0) == 0.0434727461688614366697487680258592883",  FUNC(j1) (10.0), 0.0434727461688614366697487680258592883L, DELTA1261, 0, 0);
...
jn_test (void)
{
  ...
  check_float ("jn (0, 2.0) == 0.223890779141235668051827454649948626",  FUNC(jn) (0, 2.0), 0.223890779141235668051827454649948626L, DELTA1270, 0, 0);
  check_float ("jn (0, 8.0) == 0.171650807137553906090869407851972001",  FUNC(jn) (0, 8.0), 0.171650807137553906090869407851972001L, DELTA1271, 0, 0);
  check_float ("jn (0, 10.0) == -0.245935764451348335197760862485328754",  FUNC(jn) (0, 10.0), -0.245935764451348335197760862485328754L, DELTA1272, 0, 0);
  check_float ("jn (0, 4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(jn) (0, 4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1273, 0, 0);
  check_float ("jn (0, -4.0) == -3.9714980986384737228659076845169804197562E-1",  FUNC(jn) (0, -4.0), -3.9714980986384737228659076845169804197562E-1L, DELTA1274, 0, 0);
  ...
  check_float ("jn (1, 0.75) == 0.349243602174862192523281016426251335",  FUNC(jn) (1, 0.75L), 0.349243602174862192523281016426251335L, DELTA1280, 0, 0);
  check_float ("jn (1, 1.0) == 0.440050585744933515959682203718914913",  FUNC(jn) (1, 1.0), 0.440050585744933515959682203718914913L, 0, 0, 0);
  check_float ("jn (1, 1.5) == 0.557936507910099641990121213156089400",  FUNC(jn) (1, 1.5), 0.557936507910099641990121213156089400L, 0, 0, 0);
  check_float ("jn (1, 2.0) == 0.576724807756873387202448242269137087",  FUNC(jn) (1, 2.0), 0.576724807756873387202448242269137087L, DELTA1283, 0, 0);
  check_float ("jn (1, 8.0) == 0.234636346853914624381276651590454612",  FUNC(jn) (1, 8.0), 0.234636346853914624381276651590454612L, DELTA1284, 0, 0);
  check_float ("jn (1, 10.0) == 0.0434727461688614366697487680258592883",  FUNC(jn) (1, 10.0), 0.0434727461688614366697487680258592883L, DELTA1285, 0, 0);

  /* jn (3, x)  */
  check_float ("jn (3, NaN) == NaN",  FUNC(jn) (3, nan_value), nan_value, 0, 0, 0);
  check_float ("jn (3, inf) == 0",  FUNC(jn) (3, plus_infty), 0, 0, 0, 0);

  check_float ("jn (3, -1.0) == -0.0195633539826684059189053216217515083",  FUNC(jn) (3, -1.0), -0.0195633539826684059189053216217515083L, DELTA1288, 0, 0);
  ...
  check_float ("jn (3, 0.75) == 0.848438342327410884392755236884386804e-2",  FUNC(jn) (3, 0.75L), 0.848438342327410884392755236884386804e-2L, DELTA1291, 0, 0);
  check_float ("jn (3, 1.0) == 0.0195633539826684059189053216217515083",  FUNC(jn) (3, 1.0), 0.0195633539826684059189053216217515083L, DELTA1292, 0, 0);
  check_float ("jn (3, 2.0) == 0.128943249474402051098793332969239835",  FUNC(jn) (3, 2.0), 0.128943249474402051098793332969239835L, DELTA1293, 0, 0);
  check_float ("jn (3, 10.0) == 0.0583793793051868123429354784103409563",  FUNC(jn) (3, 10.0), 0.0583793793051868123429354784103409563L, DELTA1294, 0, 0);

  /*  jn (10, x)  */
  check_float ("jn (10, NaN) == NaN",  FUNC(jn) (10, nan_value), nan_value, 0, 0, 0);
  check_float ("jn (10, inf) == 0",  FUNC(jn) (10, plus_infty), 0, 0, 0, 0);

  check_float ("jn (10, -1.0) == 0.263061512368745320699785368779050294e-9",  FUNC(jn) (10, -1.0), 0.263061512368745320699785368779050294e-9L, DELTA1297, 0, 0);
  check_float ("jn (10, 0.0) == 0.0",  FUNC(jn) (10, 0.0), 0.0, 0, 0, 0);
  check_float ("jn (10, 0.125) == 0.250543369809369890173993791865771547e-18",  FUNC(jn) (10, 0.125L), 0.250543369809369890173993791865771547e-18L, DELTA1299, 0, 0);
  check_float ("jn (10, 0.75) == 0.149621713117596814698712483621682835e-10",  FUNC(jn) (10, 0.75L), 0.149621713117596814698712483621682835e-10L, DELTA1300, 0, 0);
  check_float ("jn (10, 1.0) == 0.263061512368745320699785368779050294e-9",  FUNC(jn) (10, 1.0), 0.263061512368745320699785368779050294e-9L, DELTA1301, 0, 0);
  check_float ("jn (10, 2.0) == 0.251538628271673670963516093751820639e-6",  FUNC(jn) (10, 2.0), 0.251538628271673670963516093751820639e-6L, DELTA1302, 0, 0);
  check_float ("jn (10, 10.0) == 0.207486106633358857697278723518753428",  FUNC(jn) (10, 10.0), 0.207486106633358857697278723518753428L, DELTA1303, 0, 0);

  /* BZ #11589 .*/
  check_float ("jn (2, 2.4048255576957729) == 0.43175480701968038399746111312430703",  FUNC(jn) (2, 2.4048255576957729), 0.43175480701968038399746111312430703L, DELTA1304, 0, 0);
  check_float ("jn (3, 2.4048255576957729) == 0.19899990535769083404042146764530813",  FUNC(jn) (3, 2.4048255576957729), 0.19899990535769083404042146764530813L, DELTA1305, 0, 0);
  check_float ("jn (4, 2.4048255576957729) == 0.647466661641779720084932282551219891E-1",  FUNC(jn) (4, 2.4048255576957729), 0.647466661641779720084932282551219891E-1L, DELTA1306, 0, 0);
  check_float ("jn (5, 2.4048255576957729) == 0.163892432048058525099230549946147698E-1",  FUNC(jn) (5, 2.4048255576957729), 0.163892432048058525099230549946147698E-1L, DELTA1307, 0, 0);
  check_float ("jn (6, 2.4048255576957729) == 0.34048184720278336646673682895929161E-2",  FUNC(jn) (6, 2.4048255576957729), 0.34048184720278336646673682895929161E-2L, DELTA1308, 0, 0);
  check_float ("jn (7, 2.4048255576957729) == 0.60068836573295394221291569249883076E-3",  FUNC(jn) (7, 2.4048255576957729), 0.60068836573295394221291569249883076E-3L, DELTA1309, 0, 0);
  check_float ("jn (8, 2.4048255576957729) == 0.92165786705344923232879022467054148E-4",  FUNC(jn) (8, 2.4048255576957729), 0.92165786705344923232879022467054148E-4L, DELTA1310, 0, 0);
  check_float ("jn (9, 2.4048255576957729) == 0.12517270977961513005428966643852564E-4",  FUNC(jn) (9, 2.4048255576957729), 0.12517270977961513005428966643852564E-4L, DELTA1311, 0, 0);
...
lgamma_test (void)
{
  ...
  signgam = 0;
  check_float ("lgamma (-0.5) == log(2*sqrt(pi))",  FUNC(lgamma) (-0.5), M_LOG_2_SQRT_PIl, DELTA1332, 0, 0);
  check_int ("lgamma (-0.5) sets signgam to -1", signgam, -1, 0, 0, 0);
  signgam = 0;
  check_float ("lgamma (0.7) == 0.260867246531666514385732417016759578",  FUNC(lgamma) (0.7L), 0.260867246531666514385732417016759578L, DELTA1334, 0, 0);
  check_int ("lgamma (0.7) sets signgam to 1", signgam, 1, 0, 0, 0);
  signgam = 0;
  check_float ("lgamma (1.2) == -0.853740900033158497197028392998854470e-1",  FUNC(lgamma) (1.2L), -0.853740900033158497197028392998854470e-1L, DELTA1336, 0, 0);
...
log_test (void)
{
  ...
  check_float ("log (e) == 1",  FUNC(log) (M_El), 1, DELTA1846, 0, 0);
...
log10_test (void)
{
  ...
  check_float ("log10 (e) == log10(e)",  FUNC(log10) (M_El), M_LOG10El, DELTA1862, 0, 0);
  check_float ("log10 (0.75) == -0.124938736608299953132449886193870744",  FUNC(log10) (0.75L), -0.124938736608299953132449886193870744L, DELTA1863, 0, 0);
...
# if LONG_MAX > 281474976710656
  ...
  check_long ("lround (-3.65309740835E17) == -365309740835000000",  FUNC(llround) (-3.65309740835E17), -365309740835000000, 0, 0, 0);
# endif
...
sincos_test (void)
{
  ...
  check_float ("sincos (pi/2, &sin_res, &cos_res) puts 0 in cos_res", cos_res, 0, DELTA2657, 0, 0);
  ...
  check_float ("sincos (M_PI_6l*2.0, &sin_res, &cos_res) puts 0.86602540378443864676372317075293616 in sin_res", sin_res, 0.86602540378443864676372317075293616L, DELTA2660, 0, 0);
  check_float ("sincos (M_PI_6l*2.0, &sin_res, &cos_res) puts 0.5 in cos_res", cos_res, 0.5, DELTA2661, 0, 0);
...
sinh_test (void)
{
  ...
  check_float ("sinh (0.75) == 0.822316731935829980703661634446913849",  FUNC(sinh) (0.75L), 0.822316731935829980703661634446913849L, DELTA2671, 0, 0);
...
tan_test (void)
{
  ...
  check_float ("tan (pi/4) == 1",  FUNC(tan) (M_PI_4l), 1, DELTA2692, 0, 0);
...
tgamma_test (void)
{
  ...
  check_float ("tgamma (0.5) == sqrt (pi)",  FUNC(tgamma) (0.5), M_SQRT_PIl, DELTA2710, 0, 0);
  check_float ("tgamma (-0.5) == -2 sqrt (pi)",  FUNC(tgamma) (-0.5), -M_2_SQRT_PIl, DELTA2711, 0, 0);

  check_float ("tgamma (1) == 1",  FUNC(tgamma) (1), 1, 0, 0, 0);
  check_float ("tgamma (4) == 6",  FUNC(tgamma) (4), 6, DELTA2713, 0, 0);

  check_float ("tgamma (0.7) == 1.29805533264755778568117117915281162",  FUNC(tgamma) (0.7L), 1.29805533264755778568117117915281162L, DELTA2714, 0, 0);
...
y0_test (void)
{
  ...
  check_float ("y0 (0.125) == -1.38968062514384052915582277745018693",  FUNC(y0) (0.125L), -1.38968062514384052915582277745018693L, DELTA2794, 0, 0);
  check_float ("y0 (0.75) == -0.137172769385772397522814379396581855",  FUNC(y0) (0.75L), -0.137172769385772397522814379396581855L, DELTA2795, 0, 0);
  check_float ("y0 (1.0) == 0.0882569642156769579829267660235151628",  FUNC(y0) (1.0), 0.0882569642156769579829267660235151628L, DELTA2796, 0, 0);
  check_float ("y0 (1.5) == 0.382448923797758843955068554978089862",  FUNC(y0) (1.5), 0.382448923797758843955068554978089862L, DELTA2797, 0, 0);
  check_float ("y0 (2.0) == 0.510375672649745119596606592727157873",  FUNC(y0) (2.0), 0.510375672649745119596606592727157873L, 0, 0, 0);
  check_float ("y0 (8.0) == 0.223521489387566220527323400498620359",  FUNC(y0) (8.0), 0.223521489387566220527323400498620359L, DELTA2799, 0, 0);
  check_float ("y0 (10.0) == 0.0556711672835993914244598774101900481",  FUNC(y0) (10.0), 0.0556711672835993914244598774101900481L, DELTA2800, 0, 0);
...
y1_test (void)
{
  ...
  check_float ("y1 (0.125) == -5.19993611253477499595928744876579921",  FUNC(y1) (0.125L), -5.19993611253477499595928744876579921L, DELTA2805, 0, 0);
  check_float ("y1 (0.75) == -1.03759455076928541973767132140642198",  FUNC(y1) (0.75L), -1.03759455076928541973767132140642198L, 0, 0, 0);
  check_float ("y1 (1.0) == -0.781212821300288716547150000047964821",  FUNC(y1) (1.0), -0.781212821300288716547150000047964821L, DELTA2807, 0, 0);
  check_float ("y1 (1.5) == -0.412308626973911295952829820633445323",  FUNC(y1) (1.5), -0.412308626973911295952829820633445323L, 0, 0, 0);
  check_float ("y1 (2.0) == -0.107032431540937546888370772277476637",  FUNC(y1) (2.0), -0.107032431540937546888370772277476637L, DELTA2809, 0, 0);
  check_float ("y1 (8.0) == -0.158060461731247494255555266187483550",  FUNC(y1) (8.0), -0.158060461731247494255555266187483550L, DELTA2810, 0, 0);
  check_float ("y1 (10.0) == 0.249015424206953883923283474663222803",  FUNC(y1) (10.0), 0.249015424206953883923283474663222803L, DELTA2811, 0, 0);
...
yn_test (void)
{
  ...
  check_float ("yn (0, 0.125) == -1.38968062514384052915582277745018693",  FUNC(yn) (0, 0.125L), -1.38968062514384052915582277745018693L, DELTA2816, 0, 0);
  check_float ("yn (0, 0.75) == -0.137172769385772397522814379396581855",  FUNC(yn) (0, 0.75L), -0.137172769385772397522814379396581855L, DELTA2817, 0, 0);
  check_float ("yn (0, 1.0) == 0.0882569642156769579829267660235151628",  FUNC(yn) (0, 1.0), 0.0882569642156769579829267660235151628L, DELTA2818, 0, 0);
  check_float ("yn (0, 1.5) == 0.382448923797758843955068554978089862",  FUNC(yn) (0, 1.5), 0.382448923797758843955068554978089862L, DELTA2819, 0, 0);
  check_float ("yn (0, 2.0) == 0.510375672649745119596606592727157873",  FUNC(yn) (0, 2.0), 0.510375672649745119596606592727157873L, 0, 0, 0);
  check_float ("yn (0, 8.0) == 0.223521489387566220527323400498620359",  FUNC(yn) (0, 8.0), 0.223521489387566220527323400498620359L, DELTA2821, 0, 0);
  check_float ("yn (0, 10.0) == 0.0556711672835993914244598774101900481",  FUNC(yn) (0, 10.0), 0.0556711672835993914244598774101900481L, DELTA2822, 0, 0);
  ...
  check_float ("yn (1, 0.125) == -5.19993611253477499595928744876579921",  FUNC(yn) (1, 0.125L), -5.19993611253477499595928744876579921L, DELTA2827, 0, 0);
  check_float ("yn (1, 0.75) == -1.03759455076928541973767132140642198",  FUNC(yn) (1, 0.75L), -1.03759455076928541973767132140642198L, 0, 0, 0);
  check_float ("yn (1, 1.0) == -0.781212821300288716547150000047964821",  FUNC(yn) (1, 1.0), -0.781212821300288716547150000047964821L, DELTA2829, 0, 0);
  check_float ("yn (1, 1.5) == -0.412308626973911295952829820633445323",  FUNC(yn) (1, 1.5), -0.412308626973911295952829820633445323L, 0, 0, 0);
  check_float ("yn (1, 2.0) == -0.107032431540937546888370772277476637",  FUNC(yn) (1, 2.0), -0.107032431540937546888370772277476637L, DELTA2831, 0, 0);
  check_float ("yn (1, 8.0) == -0.158060461731247494255555266187483550",  FUNC(yn) (1, 8.0), -0.158060461731247494255555266187483550L, DELTA2832, 0, 0);
  check_float ("yn (1, 10.0) == 0.249015424206953883923283474663222803",  FUNC(yn) (1, 10.0), 0.249015424206953883923283474663222803L, DELTA2833, 0, 0);

  /* yn (3, x)  */
  check_float ("yn (3, inf) == 0",  FUNC(yn) (3, plus_infty), 0, 0, 0, 0);
  check_float ("yn (3, NaN) == NaN",  FUNC(yn) (3, nan_value), nan_value, 0, 0, 0);

  check_float ("yn (3, 0.125) == -2612.69757350066712600220955744091741",  FUNC(yn) (3, 0.125L), -2612.69757350066712600220955744091741L, DELTA2836, 0, 0);
  check_float ("yn (3, 0.75) == -12.9877176234475433186319774484809207",  FUNC(yn) (3, 0.75L), -12.9877176234475433186319774484809207L, DELTA2837, 0, 0);
  check_float ("yn (3, 1.0) == -5.82151760596472884776175706442981440",  FUNC(yn) (3, 1.0), -5.82151760596472884776175706442981440L, 0, 0, 0);
  check_float ("yn (3, 2.0) == -1.12778377684042778608158395773179238",  FUNC(yn) (3, 2.0), -1.12778377684042778608158395773179238L, DELTA2839, 0, 0);
  check_float ("yn (3, 10.0) == -0.251362657183837329779204747654240998",  FUNC(yn) (3, 10.0), -0.251362657183837329779204747654240998L, DELTA2840, 0, 0);

  /* yn (10, x)  */
  check_float ("yn (10, inf) == 0",  FUNC(yn) (10, plus_infty), 0, 0, 0, 0);
  check_float ("yn (10, NaN) == NaN",  FUNC(yn) (10, nan_value), nan_value, 0, 0, 0);

  check_float ("yn (10, 0.125) == -127057845771019398.252538486899753195",  FUNC(yn) (10, 0.125L), -127057845771019398.252538486899753195L, DELTA2843, 0, 0);
  check_float ("yn (10, 0.75) == -2133501638.90573424452445412893839236",  FUNC(yn) (10, 0.75L), -2133501638.90573424452445412893839236L, DELTA2844, 0, 0);
  check_float ("yn (10, 1.0) == -121618014.278689189288130426667971145",  FUNC(yn) (10, 1.0), -121618014.278689189288130426667971145L, DELTA2845, 0, 0);
  check_float ("yn (10, 2.0) == -129184.542208039282635913145923304214",  FUNC(yn) (10, 2.0), -129184.542208039282635913145923304214L, DELTA2846, 0, 0);
  check_float ("yn (10, 10.0) == -0.359814152183402722051986577343560609",  FUNC(yn) (10, 10.0), -0.359814152183402722051986577343560609L, DELTA2847, 0, 0);
