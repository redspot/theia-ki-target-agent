...
extern void *argsalloc(size_t);
extern void argsfree(const void*, size_t);
extern void argsfreeall(struct record_thread*);
extern char *argshead(struct record_thread*);
extern void argsconsume(struct record_thread*, u_long);
extern struct argsalloc_node *__new_argsalloc_node(void*, size_t);
extern int add_argsalloc_node(struct record_thread*, void*, size_t);
